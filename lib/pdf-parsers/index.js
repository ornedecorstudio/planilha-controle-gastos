...
export function detectarBanco(texto) {
  ...
  // XP Investimentos — antes de Renner para evitar falso positivo
  // (faturas XP contêm o verbo "realize" no texto legal/jurídico,
  //  que fazia match com a keyword genérica "REALIZE" da Renner)
