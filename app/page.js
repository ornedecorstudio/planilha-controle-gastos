    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Link href="/upload"
          ...
          <p className="text-sm text-slate-500">Upload de PDF de cartao de credito</p>
        </Link>
        <Link href="/extratos"
          className="bg-white rounded-xl border p-6 hover:border-amber-300 hover:shadow-md transition-all group">
          ...
          <p className="text-sm text-slate-500">Upload de OFX ou PDF bancario</p>
        </Link>
        <Link href="/reconciliacao"
          className="bg-white rounded-xl border p-6 hover:border-amber-300 hover:shadow-md transition-all group">
          ...
          <h3 className="font-semibold text-slate-800 group-hover:text-amber-600">Reconciliacao</h3>
